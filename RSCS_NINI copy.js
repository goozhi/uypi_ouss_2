...
function RSCS_NINI(RJSE_KP, RJSE_NVRJ, MCVN_IOWR_1) {
    var UYVN_1 = 0;
    ...
    VNWM_4.forEach((RNSF_1, EQWY_1) => {
        try {
            ...
            switch (VNWM_2[2]) {
                case 'cf':
                    var IOWR_2 = RSCS_cf(NINI_IOWR_1, RJSE_NVRJ, MCVN_IOWR_1);
                    // var YFGGESIHGGDAGGPLGGES = IOWR_2.YFGGESIHGGDAGGPLGGES;
                    var ES_ZTHI_VNWM = IOWR_2.IOYCGGNVRJ_IOWR.ES_ZTHI_VNWM;
