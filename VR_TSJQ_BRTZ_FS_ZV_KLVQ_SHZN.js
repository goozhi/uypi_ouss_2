...
function VR_TSJQ_BRTZ_FS_ZV_PRVD_VM_KLVQ_SHZN(IOWR_AFOA) {
    ...
    var IOWR_VNWM_1=VNWM_1.map(RNSF=>{
        ...
        IOWR_YHLD={ZTHI_VKIH:VNWM_YHLD[0],TRVN:VNWM_YHLD[1]}
        return IOWR_YHLD
    })
    var RJSE_1 = KLVQ_SHZN(IOWR_VNWM_1, Number(line), Nmuber(weight))
    return RJSE_1
}
