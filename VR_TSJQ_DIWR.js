...
function VR_TSJQ_DIWR() {
    ...
    },
    {
        ...
        csrf: "",
        klch: ``,
        vnwm_vr_afoa_lzm_wu: ["77"],
        VBYT_VKRF_Peng_EBWU: false
    },
    {
        vr_afoa_wu: "VR_PRVD_VM_KLVQ_SHZN",
        vr_afoa_rh: VR_TSJQ_BRTZ_FS_ZV_KLVQ_SHZN,
        csrf: "bi tsjq ra huop, bi tsjq db oc shzn data nq prvd vm mb dk tr klvq",
        klch: ``,
    ...
    },
    {
        ...
        csrf: "fywy pzre gmih nq menuData yh yj um ljey tyzv yxna",
        klch: ``,
    ...
    },
    {
        ...
        csrf: "",
        klch: ``,
        vnwm_vr_afoa_lzm_wu: ["19"],
        VBYT_VKRF_Peng_EBWU: false
    },
    {
        vr_afoa_wu: "VR_RJOK"
        , csrf: `VR_RJOK : cqpi fr : RJOK . mcvn wu : nixb . nixb=AFOA_WU : JUKL EOWL SOPC WR AFOA WU , nixb=afoa_lzm_wu : jukl eowl sopc afoa lzm wu, nixb=sopc : jukl eowl sopc rjok zzuy. uxst dk hy pc "csrf, klch"`
