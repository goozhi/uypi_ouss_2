...
function VR_EBWU_BRTZ_FS_ZV_JCBZ_UL_PZVN_UYUY_UX_NINI(RJSE_KP) {
    ...
    if (/7f/i.test(NINI_UXUX_2)) {
        ...
        if (GKQJ_PC_FRIH && GKQJ_AWZN_KLVQ) {
            ...
            DIWR_VNWM_3C_DIYC_YG_MCVN.push({ VNWM_KLVQ_MCVN: [EOWL_ZTHI_YG_ZV_PC_FRIH(AWZN_KLVQ_VN_1, PC_FRIH_SDVN_PH_HPMI, PZVN, NOKZ, !GKQJ_PC_FRIH), EOWL_ZTHI_YG_ZV_PC_FRIH(AWZN_KLVQ_VN_2, PC_FRIH_SDVN_PH_HPMI, PZVN, NOKZ, !GKQJ_PC_FRIH)], BQEO: PH_KLVQ_MCVN_1 + "*(" + PZVN + ")+(" + NOKZ + ")" })
        } else {
