...
function RSCS_3c_NINI(NINI_IOWR_1, ZTHI_VNWM) {
    if (typeof (NINI_IOWR_1) != 'object') {
        throw 'RSCS_3c_NINI : MCVN UXUX MSOX : ' + typeof (NINI_IOWR_1);
    }
    ...
    var RJSE_oth_UYTZ = ""
    var NINI_MCVN_IOWR_1 = { NINI_WU, NINI_ES, NINI_UXUX, NINI_UYPJ_1, NINI_TRVN, NINI_EYTR };
    ...
    ZTHI_VNWM.forEach(RNSF_2 => {
        ...
        if (IOWR_KLVQ_MCVN == undefined) {
            ...
            IOWR_VNWM_UYTZ_VNWM.push({ IOWR_KLVQ_MCVN, WKTR_ZTHI_VKIH: "d" + WKTR_VNWY, WKTR_ZTHI: RNSF_2, VNWY_VNWM: IMFB_VNWM, UYTZ })
        }
    })
