...
function RSCS_10_NINI(NINI_DIWR_1, ZTHI_GTAW_VNWM) {
    if (typeof (NINI_DIWR_1) != 'object') {
        throw 'RSCS_10_NINI : MCVN UXUX MSOX : ' + typeof (NINI_DIWR_1);
    }
    ...
    var NINI_MCVN_DIWR_1 = { NINI_WU, NINI_ES, NINI_UXUX, vnwm_NINI_10_mcvn_KP };
    return { NINI_10_MCVN, NINI_MCVN_DIWR_1 };
