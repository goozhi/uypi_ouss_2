...
function tsjq_tem_non(rj_kp, tsts_trig_kp) {
    ...
    var vnwm_yhld = diwr_vnwm_tsjq.map(async rn1 => {
        ...
        var diwr_vnwm_stst_mi = rn1.vnwm_vr_afoa_lzm_wu.map(rn2 => {
            return { zkrs: rn1.zkrs, rj_dbkz_tsts, gkqj_dbkz_tsts_yjab: true, rj_tsts_llcc, rj_tsts_udcc, vr_afoa_lzm_wu: rn2.toLowerCase(), stst_mi: DOVW_DPAV_UYPJ_ZV_EOWL_STST_MI(rn2, rj_dbkz_tsts.toUpperCase()) }
        })
