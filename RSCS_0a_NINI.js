...
function RSCS_0a_NINI(NINI_IOWR_1, ZTHI_GTAW_VNWM) {
    if (typeof (NINI_IOWR_1) != 'object') {
        throw 'RSCS_0a_NINI : MCVN UXUX MSOX : ' + typeof (NINI_IOWR_1);
    }
    ...
    vnwm_NINI_0a_mcvn_KP.forEach(RNSF_1 => {
        ...
        if (IOWR_ZTHI_VKIH != null) {
            ...
            VNWM_ZTHI_VKIH.forEach(rnsf_2 => {
                var IOWR_ZTHI = { ZTHI_VKIH: rnsf_2, ZTHI_YG: ZTHI_GTAW_VNWM[rnsf_2], ZTHI_DIYC_YG: ASCII_LD_RJSE(ZTHI_GTAW_VNWM[rnsf_2]) }
                NINI_0a_MCVN.push(IOWR_ZTHI)
            })
    ...
    var NINI_MCVN_IOWR_1 = { NINI_WU, NINI_ES, NINI_UXUX, vnwm_NINI_0a_mcvn_KP };
    return { NINI_0a_MCVN, NINI_MCVN_IOWR_1 };
