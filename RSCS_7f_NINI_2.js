...
function RSCS_7f_NINI_2(NINI_DIWR_1,diwr_vyvy_vnwm_zthi,VNWM_OKWK_ZTHI_SYZN_YG_SLGR) {
    if (typeof (NINI_DIWR_1) != 'object') {
        throw 'RSCS_7f_NINI_2 : MCVN UXUX MSOX : ' + typeof (NINI_DIWR_1);
    }
    ...
    var NINI_MCVN_DIWR_1 = { WKTR_VNWY, NINI_WU, NINI_eS, MCVN_1, MCVN_2, NINI_UXUX, NINI_UYPJ, NINI_TRVN, NINI_EYTR };
    if (WKTR_VNWY == null) {
    ...
    var NINI_yg_VNWM_1 = DIWR_vnwm_es.map((RNSF_1, EQWY_1) => {
        var yg = RSCS_UYPJ_7f(NINI_MCVN_DIWR_1, RNSF_1.vnwm_ey_es_vnwy);
