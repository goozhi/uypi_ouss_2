...
function RSCS_cf_NINI(NINI_IOWR_1) {
    ...
    var NINI_MCVN_IOWR_1 = { WKTR_VNWY, NINIGGWU, NINIGGeS, NINIGGUXUX, NINIGGUYPJ, NINIGGTRVN, NINIGGEYTR };
    if (WKTR_VNWY == null) {
    ...
    var NINIGGYJ_VNWM_1 = eS_IOWR_1.eS_VNWM_1.map((RNSF_1, EQWY_1) => {
        var YJ = RSCS_UYPJ_cf(NINIGGUYPJ, RNSF_1);
