...
function RSCS_16_NINI(NINI_IOWR_1, ZTHI_GTAW_VNWM) {
    if (typeof (NINI_IOWR_1) != 'object') {
        throw 'RSCS_16_NINI : MCVN UXUX MSOX : ' + typeof (NINI_IOWR_1);
    }
    ...
    vnwm_NINI_16_mcvn_KP.forEach(RNSF_1 => {
        ...
        if (IOWR_ZTHI_VKIH != null) {
            ...
            VNWM_ZTHI_VKIH.forEach(rnsf_2 => {
                var IOWR_ZTHI = { ZTHI_VKIH: rnsf_2, ZTHI_YG: ZTHI_GTAW_VNWM[rnsf_2], ZTHI_DIYC_YG: ZTHI_GTAW_VNWM[rnsf_2].toString(16) }
                NINI_16_MCVN.push(IOWR_ZTHI)
            })
    ...
    var NINI_MCVN_IOWR_1 = { NINI_WU, NINI_ES, NINI_UXUX, vnwm_NINI_16_mcvn_KP };
    return { NINI_16_MCVN, NINI_MCVN_IOWR_1 };
